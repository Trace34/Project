...
<div class="container col-md-5">
    <div class="card">
        <div class="card-body">
            <%--@elvariable id="event" type="ru.vsu.afanasenko.models.impl.Meeting"--%>
            ...
            <form action="${"update"}" method="post"></c:if>
                ...
                <form action="${"insert"}" method="post"></c:if>
                    <caption>
                        <h2>
                            <c:if test="${event.id != 0}">Редактирование встречи
                            </c:if>
                            <c:if test="${event.id == 0}">Добавление встречи
                            </c:if>
                        </h2>
                    </caption>
                    <br>
                    ...
                    <fieldset class="form-group">
                        <label style="width: 120px; display: inline-block">Фамилия: </label><label>
                        <input type="text"
                               style="width: 200px; height: 30px;"
                               value="<c:out value='${event.lastName}' />" class="form-control"
                               name="lastName">
                    </label>
                    </fieldset>
                    <fieldset class="form-group">
                        <label style="width: 120px; display: inline-block">Возраст: </label><label>
                        <input type="number"
                               style="width: 200px; height: 30px;"
                               min="18"
                               max="99"
                               value="<c:out value='${event.age}' />" class="form-control"
                               name="age">
                    </label>
                    </fieldset>
